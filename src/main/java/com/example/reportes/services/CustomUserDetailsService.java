...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        log.info("Usuario encontrado. ID: {}, Rol: {}, Contraseña: {}", usuario.getId(), usuario.getRol().getNombre(),
                usuario.getPassword());

        return User.builder()
                .username(usuario.getUsername())
                .password(usuario.getPassword())
                .roles(usuario.getRol().getNombre()) // Cambia authorities por roles
                .build();
    }
}
 ...
 * Si existe, construye un objeto UserDetails (que Spring Security usa para
 ...
 * 
 * Se envía el formulario de login (POST a /login).
 * 
